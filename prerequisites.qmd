---
title: "Prerequisites"
description-meta: "Software and knowledge prerequisites for the Data Science and Digital Tools for Transport Planning course, including setup instructions and testing code."
keywords: "prerequisites, software setup, R, Python, Quarto, Git, GitHub"
...
![Output of the Python setup test showing a visualization of road network data from Lisbon](images/paste-3.png)

:::

Let us know how you get on and let us know if you have any issues getting set up, either by email, or (preferably) via the Discussion forum on GitHub associated with this course repository at [github.com/tdscience/course/discussions](https://github.com/tdscience/course/discussions).