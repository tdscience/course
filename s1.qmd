...
|--------------------------------|------------------|------------------------------|------------------------------|
| Development status             | Mature ✅        | Under active development 🏗️ | Mature ✅                    |
| Set-up time for data science   | Minimal          | Minimal                      | Extensions needed            |
| Primary Language(s)            | R                | R and Python out-of-the-box, others (with extensions)            | Language-agnostic, any language (with extensions)            |
| Quarto Support                 | Excellent        | Excellent                    | Excellent (via extension)    |
| Devcontainers support          | Minimal          | Minimal                      | ✅                           |
| Live Share support             | ❌               | ❌                           | ✅                           |
| Plugin ecosystem              | Limited (Addins) | High (open source VS Code extensions from [OpenVSX](https://open-vsx.org/)) | High ([VS Code Marketplace](https://marketplace.visualstudio.com/)) |
| GitHub Codespaces support      | Limited               | Limited                      | ✅                           |
: Comparison of IDEs for Data Science {#tbl-ide-comparison}
