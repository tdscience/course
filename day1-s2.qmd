...
After you've logged into [github.com](https://github.com), you can use the web application to explore the world of open source software. You can, for example, search for people's profiles and repositories (the public ones) using the search bar. Try looking for a topic, a package or a researcher or developer whose work interests you.
